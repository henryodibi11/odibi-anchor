...
Read and follow `.assistant_instructions.md` before substantive work. Preserve the public package identity: distribution `odibi-anchor`, import `odibi_anchor`, and CLI `anchor`.
